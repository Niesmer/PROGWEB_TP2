    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 mb-6">
            <div class="flex justify-between items-start">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nouveau Devis SAV</h1>
                ...
                <div class="flex gap-4 items-end flex-wrap">
                    <div class="flex-1 min-w-[200px]">
                        ...
                        <div class="relative">
                            ...
                            <div id="articleDropdown" class="hidden absolute z-10 w-full mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                ...
                                <div class="article-option p-3 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer border-b border-gray-100 dark:border-gray-600 last:border-0"
                                    ...
                                    <div class="font-medium text-gray-900 dark:text-white"><?= htmlspecialchars($article['code_article']) ?> - <?= htmlspecialchars($article['designation']) ?></div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        Forfait: <?= number_format($article['forfait_ht'], 2, ',', ' ') ?> € HT / <?= htmlspecialchars($article['unite_libelle']) ?>
